...
class TextViewPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: _buildBody(context, ref, workspaceState, workspace),
    );
  }
  ...
  Widget _buildBody(
    ...
    WidgetRef ref,
    AsyncValue<Workspace?> workspaceState,
    Workspace? workspace,
  ) {
    ...
    if (workspaceState.isLoading && workspace == null) {
    ...
    final filesState = ref.watch(workspaceTextFilesProvider);
    return filesState.when(
      ...
      error: (error, _) => AsyncErrorView(
        error: error,
        message: '文本加载失败',
        onRetry: () => ref.invalidate(workspaceTextFilesProvider),
      ),
    );
  }
}
